...
import Main.Main;
import Managers.FileChecker.File.Type;
/**
...
public class FileChecker {
    ...
    public FileChecker(Main plugin, FileManager fileManager, String configurationFileName, boolean applyComments) {
        this.fileManager = fileManager;

        loadedFiles = new EnumMap<Type, File>(File.Type.class);
